...
import (
	...
	azure "github.com/virtualcloudfoundry/goaci"
)
...
const (
	...
	containerGroupUsageURLPath               = "subscriptions/{{.subscriptionId}}/providers/Microsoft.ContainerInstance/locations/{{.location}}/usages"
